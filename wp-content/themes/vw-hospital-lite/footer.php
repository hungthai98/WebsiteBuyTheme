      ...
      <div class="footer-content">
        ...
        <div class="inner">
          <div class="copyright text-center">
             <p><?php vw_hospital_lite_credit(); ?> <?php echo esc_html(get_theme_mod('vw_hospital_lite_footer_copy',__('By VWThemes','vw-hospital-lite'))); ?></p>
              <?php if( get_theme_mod( 'vw_hospital_lite_hide_show_scroll',true) != '') { ?>
