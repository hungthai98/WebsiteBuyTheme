...
function vw_hospital_lite_font_url() {
	...
	$font_family[] = 'Open Sans:400,400i,600,600i,700,700i,800,800i';
...
function vw_hospital_lite_scripts() {
	...
	wp_enqueue_style( 'vw-hospital-lite-fontawesome', esc_url(get_template_directory_uri()) . '/css/fontawesome-all.css' );
...
if ( ! function_exists( 'vw_hospital_lite_credit' ) ) {
	function vw_hospital_lite_credit(){
		echo "<a href=".esc_url(VW_HOSPITAL_LITE_CREDIT).">". esc_html__('Hospital WordPress Theme','vw-hospital-lite')."</a>";
	}
}
...
function vw_hospital_lite_sanitize_email( $email, $setting ) {
