...
function vw_hospital_lite_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('vw_hospital_lite_loader_icon',array(
        'default' => 'Two Way',
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_hospital_lite_loader_icon',array(
        'type' => 'select',
        'label' => __('Pre-Loader Type','vw-hospital-lite'),
        'section' => 'vw_hospital_lite_left_right',
        'choices' => array(
            'Two Way' => __('Two Way','vw-hospital-lite'),
            'Dots' => __('Dots','vw-hospital-lite'),
            'Rotate' => __('Rotate','vw-hospital-lite')
        ),
	) );
    ...
    $wp_customize->add_setting('vw_hospital_lite_contact_email',array(
        'default'   => '',
        'sanitize_callback' => 'vw_hospital_lite_sanitize_email',
    ));
    ...
    $wp_customize->add_setting( 'vw_hospital_lite_metabox_hide_show',array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_hospital_lite_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Hospital_Lite_Toggle_Switch_Custom_control( $wp_customize, 'vw_hospital_lite_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','vw-hospital-lite' ),
      'section' => 'vw_hospital_lite_responsive_media'
    )));
...
final class VW_Hospital_Lite_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(new VW_Hospital_Lite_Customize_Section_Pro($manager,'vw_hospital_lite_get_started_link',array(
			...
			'pro_url'  => esc_url( 'themes.php?page=vw_hospital_lite_guide' )
		)));
	}
